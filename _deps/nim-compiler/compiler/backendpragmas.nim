...
proc processPushBackendOption*(
    optionsStack: var seq[TOptions], options: var TOptions, n: PNode, start: int
) =
...
template processPopBackendOption*(
    optionsStack: var seq[TOptions], options: var TOptions
) =
