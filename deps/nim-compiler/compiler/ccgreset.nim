...
proc specializeResetN(p: BProc, accessor: Rope, n: PNode, typ: PType) =
  if n == nil:
    return
  case n.kind
  of nkRecList:
...
proc specializeResetT(p: BProc, accessor: Rope, typ: PType) =
  ...
  of {
    tyNone, tyEmpty, tyNil, tyUntyped, tyTyped, tyGenericInvocation, tyGenericParam,
    tyOrdinal, tyOpenArray, tyForward, tyVarargs, tyUncheckedArray, tyProxy,
    tyBuiltInTypeClass, tyUserTypeClass, tyUserTypeClassInst, tyCompositeTypeClass,
    tyAnd, tyOr, tyNot, tyAnything, tyStatic, tyFromExpr, tyConcept, tyVoid, tyIterable,
  }:
    discard
