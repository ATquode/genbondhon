...
type
  TSpecialWord* = enum
    ...
    wSystemRaisesDefect = "systemRaisesDefect"
    wRedefine = "redefine"
    wCallsite = "callsite"
    wQuirky = "quirky"
    wAuto = "auto"
    ...
    wClass = "class"
    wCompl = "compl"
    wConstCast = "const_cast"
    wDefault = "default"
    wDelete = "delete"
    wDouble = "double"
    wDynamicCast = "dynamic_cast"
    wExplicit = "explicit"
    wExtern = "extern"
    wFalse = "false"
    wFloat = "float"
    ...
    wPublic = "public"
    wRegister = "register"
    wReinterpretCast = "reinterpret_cast"
    wRestrict = "restrict"
    wShort = "short"
    wSigned = "signed"
    wSizeof = "sizeof"
    wStaticCast = "static_cast"
    wStruct = "struct"
    wSwitch = "switch"
    wThis = "this"
    wThrow = "throw"
...
const
  ...
  cppNimSharedKeywords* = {
    wAsm, wBreak, wCase, wConst, wContinue, wDo, wElse, wEnum, wExport, wFor, wIf,
    wReturn, wStatic, wTemplate, wTry, wWhile, wUsing,
  }
