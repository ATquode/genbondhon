...
check bindingApis.len == publicApiCount + 3 - unwrappableAST.len
  # public APIs + NimMain() + anonymous tuples (2) - Unwrappable APIs

var expectedWrapperProcs = @["Int2Tuple", "Int3Tuple", "NimMain"]
